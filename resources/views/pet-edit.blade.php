                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                ...
                                                <input value="{{$result[0]->animal_name}}" type="text" name="name" id="name" class="form-control form-control-lg" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <label class="form-label" for="species">Species *</label>
                                                <input value="{{$result[0]->species}}" type="text" name="species" id="species" class="form-control form-control-lg" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        @if(Session::has('dateError'))
                                            <div class="col-md-6 mb-4 d-flex align-items-center">
                                                <div class="form-outline datepicker w-100">
                                                    ...
                                                    <input value="{{$result[0]->discovery_date}}" type="date" placeholder="dd-mm-yyyy" min="01.01.1900" name="discoveryDate" class="form-control form-control-lg is-invalid" id="discoveryDate" data-date-format='d-m-Y'/>
                                                </div>
                                            </div>
                                        @else
                                            <div class="col-md-6 mb-4 d-flex align-items-center">
                                                <div class="form-outline datepicker w-100">
                                                    <label for="discoveryDate" class="form-label">Discovery Date</label>
                                                    <input value="{{$result[0]->discovery_date}}" type="date" placeholder="dd-mm-yyyy" min="01.01.1900" name="discoveryDate" class="form-control form-control-lg" id="discoveryDate" data-date-format='d-m-Y'/>
                                                </div>
                                            </div>
                                        @endif
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                ...
                                                <input value="{{$result[0]->discovery_place}}" type="text" name="discoveryPlace" id="discoveryPlace" class="form-control form-control-lg" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
